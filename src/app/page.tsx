...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center pt-8 pb-0 px-4 font-inter">
      <section className="w-full flex-1 flex flex-col relative pt-4">
        <Map />
      </section>

      <footer className="w-full mt-0 mb-0 flex flex-col items-center gap-2 text-center text-[10px] sm:text-xs text-slate-400">
