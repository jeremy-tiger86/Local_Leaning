...
export default function AboutPage() {
    return (
        <main className="fixed inset-0 z-50 bg-slate-200 flex justify-center font-inter text-slate-800">
            <div className="w-full max-w-[480px] bg-white h-[100dvh] shadow-2xl shadow-blue-900/5 flex flex-col relative">
                {/* Header */}
